...
class Licitante(Usuario):
    def __init__(self, uid: int, nombre: str, apellido: str, email: str, usuario: str, clave: str, nacimiento: date):
        super().__init__(uid, nombre, apellido, email, usuario, clave, nacimiento, TipoDeUsuario.Licitante)
...
class Usuarios(ABC):
    ...
    def crear(uid: int, nombre: str, apellido: str, email: str, usuario: str, clave: str, nacimiento: date,
        ...
        elif tipo == TipoDeUsuario.Licitante or tipo == TipoDeUsuario.Licitante.value:
            return Licitante(uid, nombre, apellido, email, usuario, clave, nacimiento)
        else:
