...
class ControladorSubastaTests(unittest.TestCase):
    ...
    @data(
        ...
        (C.TITULO_SUBASTA, "", C.IMAGEN_SUBASTA, C.FECHA_DE_SUBASTA, "descrição", ServicioSubasta.SIN_DESCRIPCION),
        (C.TITULO_SUBASTA, None, C.IMAGEN_SUBASTA, C.FECHA_DE_SUBASTA, "descrição", ServicioSubasta.SIN_DESCRIPCION),
    ...
    def test_crear_subasta_correctamente_cuando_datos_completos(self):
        ...
        self.assertIn("O leilão está marcado para", respuesta["mensaje"])
