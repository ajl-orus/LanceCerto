...
from model.usuarios import Consignatario, Martillero, Licitante, Usuarios
...
class ControladorUsuarioTests(unittest.TestCase):
    def setUp(self):
        self.__db_con_usuario = CreadorDeBasesDeDatosTemporales() \
            .con_usuarios(UsuariosEnMemoria({
                C.NOMBRE_USUARIO: {
                    "id": C.ID_USUARIO,
                    "nome": C.NOMBRE_USUARIO,
                    "sobrenome": C.APELLIDO_USUARIO,
                    "email": C.EMAIL_USUARIO,
                    "usuario": C.NOMBRE_USUARIO,
                    "clave": C.CLAVE_USUARIO,
                    "nascimento": C.FECHA_NACIMIENTO_USUARIO,
                    "tipo": TipoDeUsuario.Licitante
                }})) \
            .construir()

    @data(TipoDeUsuario.Martillero, TipoDeUsuario.Consignatario, TipoDeUsuario.Licitante)
    ...
    @data(
        ...
        (C.NOMBRE_USUARIO, "", C.OTRO_EMAIL_USUARIO, C.NOMBRE_USUARIO, C.CLAVE_USUARIO, C.FECHA_NACIMIENTO_USUARIO,
         TipoDeUsuario.Licitante, ServicioUsuario.SIN_APELLIDO),
        ...
        (C.NOMBRE_USUARIO, C.APELLIDO_USUARIO, None, C.NOMBRE_USUARIO, C.CLAVE_USUARIO, C.FECHA_NACIMIENTO_USUARIO,
         TipoDeUsuario.Licitante, ServicioUsuario.SIN_EMAIL),
        ...
        (C.NOMBRE_USUARIO, C.APELLIDO_USUARIO, C.OTRO_EMAIL_USUARIO, C.NOMBRE_USUARIO, "", C.FECHA_NACIMIENTO_USUARIO,
         TipoDeUsuario.Licitante, ServicioUsuario.SIN_CLAVE),
        ...
        (C.NOMBRE_USUARIO, C.APELLIDO_USUARIO, C.OTRO_EMAIL_USUARIO, C.NOMBRE_USUARIO, C.CLAVE_USUARIO, None,
         TipoDeUsuario.Licitante, ServicioUsuario.SIN_NACIMIENTO),
    )
    @unpack
    ...
    def test_graba_usuario_de_tipo_licitante(self):
        diccionario = {}
        ...
        sut.agregar(C.NOMBRE_USUARIO, C.APELLIDO_USUARIO, C.OTRO_EMAIL_USUARIO, C.NOMBRE_USUARIO, C.CLAVE_USUARIO,
                    C.FECHA_NACIMIENTO_USUARIO, TipoDeUsuario.Licitante)
        self.assertEqual(TipoDeUsuario.Licitante, diccionario[C.NOMBRE_USUARIO]["tipo"])
    ...
    @data(
        ...
        (TipoDeUsuario.Licitante, Licitante)
    )
    @unpack
    ...
    def test_actualizar_datos_correctamente(self):
        ...
        self.assertEqual(C.FECHA_NACIMIENTO_USUARIO, usuario.obtener_nacimiento())
        self.assertEqual(TipoDeUsuario.Licitante, usuario.obtener_tipo())
    ...
    def test_retornar_ok_al_contactar_correctamente_al_martillero(self):
        ...
        sut.contactar(C.NOMBRE_USUARIO, C.EMAIL_USUARIO, "breve assunto", "texto extenso", EmailSenderSpy())
        respuesta = sut.obtener_respuesta()
        self.assertEqual("ok", respuesta["status"])
