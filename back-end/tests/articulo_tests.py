...
#        self.assertEqual(C.VALUACION_ARTICULO, articulo.obtener_valuacion())
    ...
    def test_retornar_articulo_al_buscar_articulo_creado(self):
        ...
        respuesta = sut.obtener_respuesta()
        self.assertEqual("ok", respuesta["status"])
        self.assertEqual({"consignatario_id": 1, "id": 1, "titulo": "Sofa Antigo",
                          "descrição": "Sofá do início do século.", "avaliação": 15000}, respuesta["item"])
    ...
    def test_retornar_articulos_al_buscar_por_consignatario_existente_con_articulos(self):
        ...
        self.assertIn({"id": 1, "consignatario_id": 1, "titulo": "Sofa Antigo",
                       "descrição": "Sofá do início do século.", "avaliação": 15000}, respuesta["items"])
        self.assertIn({"id": 2, "consignatario_id": 1, "titulo": "Relógio de areia",
                       "descrição": "Uma ampulheta que desacelera.", "avaliação": 3000}, respuesta["items"])
    ...
    def test_listar_elementos_cuando_hay_articulos(self):
        ...
        self.assertIn({
            "consignatario_id": 1,
            "descrição": "Sofá do início do século.",
            "id": 1,
            "titulo": "Sofa Antigo",
            "avaliação": 15000}, respuesta["items"])
        self.assertIn({
            "consignatario_id": 1,
            "descrição": "Uma ampulheta que desacelera.",
            "id": 2,
            "titulo": 2,
            "avaliação": 3000}, respuesta["items"])
        sut.listar()
